...
{
    return [[CJFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[CJFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[CJFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[CJFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[CJFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[CJFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
